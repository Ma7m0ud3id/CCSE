...
class PresentationSkills extends StatelessWidget {
static const String routName='klkjuhjgjhgghfgsnxn';

  @override
  Widget build(BuildContext context) {
    var presentationSkills= ModalRoute.of(context)?. settings.arguments as String;
    return Scaffold(
      appBar: AppBar(
        title: Text('$presentationSkills',style: TextStyle(fontSize: 25,
      ...
      Row(
        children: [
          ...
          InkWell(
            onTap: (){
              Navigator.pushNamed(context, Lecture6.routName);
          ...
          InkWell(
            onTap: (){
              Navigator.pushNamed(context, Section6.routName);
