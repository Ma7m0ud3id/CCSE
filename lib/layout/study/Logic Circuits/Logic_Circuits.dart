...
class LogicCircuits extends StatelessWidget {
static const String routName='klksl;kojojnxn';

  @override
  Widget build(BuildContext context) {
    var logicCircuits= ModalRoute.of(context)?. settings.arguments as String;
    return Scaffold(
      appBar: AppBar(
        title: Text('$logicCircuits',style: TextStyle(fontSize: 25,
      ...
      Row(
        children: [
          ...
          InkWell(
            onTap: (){
              Navigator.pushNamed(context, Lecture4.routName);
          ...
          InkWell(
            onTap: (){
              Navigator.pushNamed(context, Section4.routName);
